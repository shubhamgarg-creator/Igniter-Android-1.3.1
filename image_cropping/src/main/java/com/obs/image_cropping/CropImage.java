...
public final class CropImage {
    ...
    public static final class ActivityBuilder {
        ...
        public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls) {
            ...
            intent.putExtra("is_default_croping", mOptions.isDefaultlyCroppingEnabled);
        ...
        public ActivityBuilder setDefaultlyCropEnabled(boolean b) {
            mOptions.isDefaultlyCroppingEnabled = b;
            return this;
        }
    }
    //endregion
